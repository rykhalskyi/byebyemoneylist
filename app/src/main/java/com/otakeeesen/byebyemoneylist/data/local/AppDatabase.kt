...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        internal val MIGRATION_16_TO_17 = Migration(16, 17) { db ->
        ...
        internal val MIGRATION_18_TO_19 = Migration(18, 19) { db ->
            db.execSQL("ALTER TABLE categories ADD COLUMN isIncome INTEGER NOT NULL DEFAULT 0")
            db.execSQL("ALTER TABLE products ADD COLUMN isIncome INTEGER NOT NULL DEFAULT 0")
        ...
        internal val MIGRATION_20_TO_21 = Migration(20, 21) { db ->
        ...
        internal val MIGRATION_23_TO_24 = Migration(23, 24) { db ->
            db.execSQL("ALTER TABLE categories ADD COLUMN serverId TEXT DEFAULT NULL")
        }

        internal val MIGRATION_24_TO_25 = Migration(24, 25) { db ->
            db.execSQL("ALTER TABLE stores ADD COLUMN serverId TEXT DEFAULT NULL")
        }

        internal val MIGRATION_25_TO_26 = Migration(25, 26) { db ->
        ...
        // Store sync gained synced fields (address + category links, Ticket B), which
        // changes the canonical projection from {name} to {name, address, categoryServerIds}.
        // Stale {name}-shaped base snapshots would flag every store as changed on both
        // sides; dropping the bookkeeping rows lets the next plan re-baseline cleanly.
        internal val MIGRATION_28_TO_29 = Migration(28, 29) { db ->
